...
<script>
    ...
    <form:form modelAttribute="user" id="infoForm" method="post" onsubmit="return formCheck()">
    ...
    <label for="">아이디</label>
    <input class="input-field" type="text" id="id" name="id" value="${user.id}" readonly>
    ...
    <label for="">이메일</label>
    <input class="input-field" type="text" id="email" name="email" value="${user.email}">
    <label for="">생일</label>
    <input class="input-field" type="text" id="birth" name="birth" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${user.birth}"/>">
