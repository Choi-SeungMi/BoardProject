...
<form:form modelAttribute="user">
  ...
  <input class="input-field" type="text" id="id" name="id" placeholder="4~12자리의 영대소문자와 숫자 조합" value="<c:out value='${user.id}'/>">
  <label for="">비밀번호</label>
  <input class="input-field" type="password" id="pwd" name="pwd" placeholder="8~12자리의 영대소문자와 숫자 조합" value="<c:out value='${user.pwd}'/>">
  <label for="">이름</label>
  <input class="input-field" type="text" id="name" name="name" placeholder="홍길동" value="<c:out value='${user.name}'/>">
  <label for="">이메일</label>
  <input class="input-field" type="text" id="email" name="email" placeholder="example@openboard.co.kr" value="<c:out value='${user.email}'/>">
  <label for="">생일</label>
  <input class="input-field" type="text" id="birth" name="birth" placeholder="2023-01-01" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${user.birth}"/>">
